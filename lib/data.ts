import groups from "@/seed/groups.json";
  ...
  return [
    {
      ...
      description: `Arquivo local com ${groups.length} grupos da Copa.`,
      statusLabel: "ok",
      statusClass: "open"
    },
    {
      title: "Importar selecoes",
      description: `Arquivo oficial com ${teams.length} selecoes da Copa.`,
      statusLabel: "ok",
      statusClass: "open"
    },
    {
      title: "Importar jogos",
      description: "Fonte unica de verdade local, pronta para completar o mata-mata.",
      statusLabel: "docker",
      statusClass: "locked"
    }
  ];
